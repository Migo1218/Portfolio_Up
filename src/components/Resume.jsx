                ...
                <div>
                  <div className="md:grid grid-cols-2 w-full m-auto p-5">
                    ...
                    <div className="md:border-r-4 border-slate-300">
                      <p className="text-bluePortfolio font-semibold text-2xl mt-1">
                        {item.name}
                      </p>
                      <p className="text-slate-700 italic text-lg mt-1">
                        {item.company} / {item.typeWork}
                      </p>
                      <p className="text-slate-700 text-lg mt-1">{item.date}</p>
                    ...
                    <div className="mt-5 md:mt-0 pl-4">
                      <p className="text-bluePortfolio font-semibold text-2xl">
                        {item.company}
                      </p>
                      {item.tasks.map((task) => (
